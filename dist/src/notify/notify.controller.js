...
const update_notify_dto_1 = require("./dto/update-notify.dto");
const pars_money_pipe_1 = require("../common/pipes/pars-money.pipe");
...
__decorate([
    ...
    __param(0, (0, common_1.Param)('price', pars_money_pipe_1.ParsMoneyPipe)),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_notify_dto_1.UpdateNotifyDto]),
    __metadata("design:returntype", void 0)
], NotifyController.prototype, "update", null);
__decorate([
